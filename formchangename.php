...
<tr>
<form>
<td width ="70" align="center"><b>FullName</b></td>
<td width = "2">:</td>
<td width ="70"  ><?php echo $result['HoTen']; ?></td>
</form>
</tr>
<form name ="form2" method="post" action="changename.php">

<tr>
<td width ="30" align="center"><b>NewName</b> </td>
<td width = "">:</td>
<td width ="294" ><input name= "myname" type="text" id="myname"></td>
<td><input type ="submit" name="Change1" value ="Submit"></td>
</tr>
</form>
<form name ="form3" method="post" action="changeemail.php">
<tr>
...
<form name ="form4" method="post" action="changepass.php">
<tr>
